...
class RenderSystem:
    ...
    @staticmethod    
    def render_explosion(explosion_system_instance):
        for explosion in explosion_system_instance.explosions:
